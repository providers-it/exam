...
var jsonvar=document.getElementById('json_subject_range').value;
...
showquestion(firstquestionofsubject);
}
}
var subjectdivid="cate-"+current_cate;
var subjectnametxt=document.getElementById(subjectdivid).innerHTML;
document.getElementById('subject_name_view').innerHTML="You are viewing <b>"+subjectnametxt+"</b> section";
}
...
if(index == 0){
firstquestionofsubject=element;
}
var nq="nq"+element;
...
//document.getElementById("quiz_submit").disabled = false;
