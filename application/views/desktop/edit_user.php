									...
									<!--	<div class="form-group">
										...
										<div class="form-group">
             							 ...
             							 <div class="form-group">
											...
											<?php if($user['institute_id'] == $center['su_institute_id']){  echo "selected"; } ?>> <?php echo $center['organization_name']; ?></option>
											<?php } ?>
										 ...
										 <div class="form-group">
											...
											<?php if($user['cid'] == $subject['cid']){  echo "selected"; } ?>> <?php echo $subject['subject_name']; ?></option>
											<?php } ?>
											</select>
										 </div>
