    ...
    <div class="row" style="margin-top:10px;">
        ...
        <div class="formbox" style="max-width:800px;">
            ...
            <div class="subject_box" id="qmanbtn" onClick="changetabqselection('qman','qauto','0');"
                 style="height:25px;"><a class="tooltip" href="javascript:changetabqselection('qman','qauto','0');"
                                         id="qmanbtna" style="color:#212121;opacity:1;">Manually <span> <img
                                class="callout" src="<?php echo base_url(); ?>images/callout_black.gif"/> <strong> Select questions manually</strong><br/>You have to select questions one by one from question bank. </span></a>
            </div>
            <div style="clear:both;"></div>
            <br><br>
            <div class="subject_box" id="qautobtn" style='background:#2f72b7;color:#ffffff;height:25px;'
                 onClick="changetabqselection('qauto','qman','1');">
                <a class="tooltip" href="javascript:changetabqselection('qauto','qman','1');" id="qautobtna"
                   style="color:#ffffff;opacity:1;">Automatically <span>
 <img class="callout" src="<?php echo base_url(); ?>images/callout_black.gif"/> <strong> System select questions randomly</strong><br/>You just need to define subject, difficulty level and number of questions you want in the quiz. </span></a>
            </div>
            ...
            <table id="formdata">
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <input id="quiz_add" type="submit" value="Add questions" name="quiz_add"
