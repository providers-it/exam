...
?>
<div class="subject_box" id="cate-<?php echo $key;?>" <?php if($key=="0"){ echo "style='background:#2f72b7;color:#ffffff;'"; }?> onClick="changesubject('<?php echo $key;?>');"><?php echo $cvalue; ?></div>
...
<tr><td> <?php echo $question['question'];
 ?></td></tr>
<?php 
$opcount=0;
// shuffle options 
...
$subject_number+=1;
?>
<a href="#"   class="btn btn-success" style="cursor:pointer;"  onClick="showquestion('<?php echo $key+1;?>','<?php echo $question['q_type'];?>');changesubject('<?php echo $subject_number;?>')update_curr_ans('<?php echo $key;?>','<?php echo $question['q_type'];?>');" >Save & Next</a>
<?php
}else{
?>
<a href="#"   class="btn btn-success" style="cursor:pointer;" onClick="showquestion('<?php echo $key+1;?>','<?php echo $question['q_type'];?>');update_curr_ans('<?php echo $key;?>','<?php echo $question['q_type'];?>');" >Save & Next</a>
...
$subject_number+=1;
?>
<a href="#"   class="btn btn-success"  onClick="showquestion('<?php echo $key+1;?>','<?php echo $question['q_type'];?>');changesubject('<?php echo $subject_number;?>');update_curr_ans('<?php echo $key;?>','<?php echo $question['q_type'];?>','<?php echo $question['qid'];?>');" >Save & Next</a>
<?php
}else{
?>
