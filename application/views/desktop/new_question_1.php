                        ...
                        <form method="post" action="<?php echo site_url('qbank/add_new_mul'); ?>">
                            ...
                            <div class="form-group">
                                <table>
                                    ...
                                    <tr>
                                        <td valign="top">1) &nbsp;&nbsp; <input id="CheckBox[]" type="checkbox"
                                                                                name="CheckBox[]" value="0"/></td>
                                        <td valign="top">
                                            <textarea name="option[]"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td valign="top">2) &nbsp;&nbsp; <input id="CheckBox[]" type="checkbox"
                                                                                name="CheckBox[]" value="1"/></td>
                                        <td valign="top">
                                            <textarea name="option[]"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td valign="top">3) &nbsp;&nbsp; <input id="CheckBox[]" type="checkbox"
                                                                                name="CheckBox[]" value="2"/></td>
                                        <td valign="top">
                                            <textarea name="option[]"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td valign="top">4) &nbsp;&nbsp; <input id="CheckBox[]" type="checkbox"
                                                                                name="CheckBox[]"
                                                                                value="3"/><?php $op = "5"; ?></td>
                                        <td valign="top">
                                            <textarea name="option[]"></textarea></td>
