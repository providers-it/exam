            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form method="post"
                              action="<?php echo site_url('qbank/edit_question/' . $result['0']['qid']) . '/3'; ?>">
                            ...
                            <div class="form-group"><label>Answer</label>
                                ...
                                <p class="help-block">
                                    Give comma separated answer (Eg: answer1,answer2). User input will be matched with
                                    any one. Not case sensitive
                                </p>
                            </div>
