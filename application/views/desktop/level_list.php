                        ...
                        if ($result == false) {
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td data-th="Action"><a
                                                href="javascript: if(confirm('Do you really want to remove this level?')){ window.location='<?php echo site_url('difficultlevel/remove_level/' . $row->did); ?>'; }"
                                                class="btn btn-danger btn-xs">Remove</a>
                                        <a href="<?php echo site_url('difficultlevel/edit_level/' . $row->did); ?>"
