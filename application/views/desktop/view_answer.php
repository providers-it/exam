        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="panel-group" id="accordion">
                    <a href="<?php echo site_url('result/view/' . $id . '/' . $result->quid); ?>"
                        ...
                        if ($question['q_type'] == "0") {
                            ...
                            <table id="ques<?php echo $key; ?>" class="<?php if ($key == '0') {
                                ...
                                if ($question['description'] != "") {
                                    ?>
                                    <tr>
                                        <td><b>Description</b><br> <?php echo $question['description']; ?></td>
                                    </tr>
                                    <?php
                                }
                                                ...
                                                <table>
                                                    <tr>
                                                        <td style="width:10px; border:0px;"><input type="radio"
                                                                                                   ...
                                                                                                   value="<?php echo $option['oid']; ?>" <?php if (in_array($option['oid'], $oids)) {
                                                                echo "checked";
                                                            } ?> ></td>
                                                        <td style="border:0px;width:750px;"> <?php echo $option['option_value']; ?> </td>
                                                        <td valign="top"><?php if ($option['score'] == "1") { ?><img
                                    ...
                                    <td>
                                        ...
                                        if ($key >= "1") {
                                            ...
                                            <input type="button" value="Back"
                                                   onClick="showquestion_afterquiz('<?php echo $key - 1; ?>');"
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td style="border:0px;width:750px;"> <?php echo $option['option_value']; ?> </td>
                                                        <td valign="top"><?php if ($option['score'] > "0") { ?><img
                                                                src="<?php echo base_url(); ?>images/tick-icon.png"><?php } ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td valign="top"><?php if (strip_tags($option['option_value']) == $given_ans_fillups[$fill]) { ?>
                                                                <img
                                                                src="<?php echo base_url(); ?>images/tick-icon.png"><?php } ?>
                                                        </td>
                                                    </tr>
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <?php if ($given_ans_short[$short_ans] != "") { ?>
                                                            <td valign="top"><?php if (strpos(strip_tags($option['option_value']), $given_ans_short[$short_ans]) !== false) { ?>
                                                                    <img
                                                                    src="<?php echo base_url(); ?>images/tick-icon.png"><?php } ?>
                                                            </td>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                ...
                                                <td style="border:0px;width:750px;"> <?php echo "Answer:<br>" . $given_ans_essay[$essay_ans]; ?> </td>
                                                </td></tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        ...
                                        if ($logged_in['su'] == "1") {
                                            if ($essay_status[$essay_ans] == "0") {
                                                ...
                                                <input type="text" id="essay_score<?php echo $essay_ans; ?>"
                                                       placeholder="Enter the score">
                                                <span id="scorebtn<?php echo $essay_ans; ?>"><input type="button"
                                                                                                    value="ADD SCORE"
                                                                                                    onClick="add_score('<?php echo $question['qid']; ?>','<?php echo $id; ?>','<?php echo $essay_ans; ?>');"
...
<table>
    <tr>
        <td>
            <div class="count_btn" style="background:#267B02;">&nbsp;</div>
            Correct
        </td>
    </tr>
    <tr>
        <td>
            <div class="count_btn" style="background:#D03800;">&nbsp;</div>
            Wrong
        </td>
    </tr>
    <tr>
        <td>
            <div class="count_btn" style="background:#212121;">&nbsp;</div>
            Not Attempted
        </td>
    </tr>
</table>
