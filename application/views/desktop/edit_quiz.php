                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type='text' class="form-control" name='quiz_name'
                                       value="<?php echo $result->quiz_name; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type='text' name='test_start_time' class="form-control"
                                       value="<?php echo date('Y/m/d', $result->start_time); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="pass_percentage" class="form-control">
                                    <?php for ($i = 0; $i <= 100; $i++) { ?>
                                        <option value="<?php echo $i; ?>" <?php if ($result->pass_percentage == $i) {
                                            echo "selected";
                                        } ?> ><?php echo $i; ?>%
                                        </option>
                                    <?php } ?>
                                ...
                                <select class="form-control" id="centerName" name="centers">
                                    ...
                                    <?php foreach ($allcenters as $key => $center) { ?>
                                        <option value="<?php echo $center['su_institute_id']; ?>"
                                            <?php if ($quiz['institute_id'] == $center['su_institute_id']) {
                                                echo "selected";
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group" id="checkBox">
                                    ...
                                    foreach ($batches as $key => $batch) { ?>
                                        <?php echo $batch['batch_name']; ?><input type="checkbox"
                                                                                  name="assigned_batches[]"
                                                                                  value="<?php echo $batch['gid']; ?>" <?php if (in_array($batch['gid'], $assigned_gids)) {
                                            echo "checked";
                                        } ?> > &nbsp;&nbsp;
                                        <?php if ($batch_counter % 5 == 0) {
                                            echo "</br>";
                                        }
                                        $batch_counter++;
                                    } ?>
...
<input type="hidden" name="test_charges" value="0">
                            ...
                            <div class="form-group">
                                ...
                                <input type='radio' name='view_answer'
                                       value='1' <?php if ($result->view_answer == "1") {
                                    echo "checked";
                                } ?> >Yes &nbsp;&nbsp;&nbsp;
                                <input type='radio' name='view_answer'
                                       value='0' <?php if ($result->view_answer == "0") {
                                    echo "checked";
                                } ?> >No
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="max_attemp" class="form-control">
                                    <?php for ($i = 1; $i <= 1000; $i++) { ?>
                                        <option value="<?php echo $i; ?>" <?php if ($result->max_attempts == $i) {
                                            echo "selected";
                                        } ?> ><?php echo $i; ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="qiz_type" class="form-control">
                                    <option value="0" <?php if ($result->pract_test == "0") {
                                        echo "selected";
                                    } ?> >Exam
                                    </option>
                                    <option value="1" <?php if ($result->pract_test == "1") {
                                        echo "selected";
                                    } ?> >Practice
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                if ($this->config->item('webcam_plugin')) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type='radio' name='camera_req'
                                               value='1' <?php if ($result->camera_req == "1") {
                                            echo "checked";
                                        } ?> >Yes
                                        <input type='radio' name='camera_req'
                                               value='0' <?php if ($result->camera_req == "0") {
                                            echo "checked";
                                        } ?> >No
                                    </div>
                                    <?php
                                ...
                                if ($result->qselect == "1") {
                                    ...
                                    foreach ($assigned_questions as $key => $val) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="cid[]">
                                                ...
                                                <?php foreach ($allsubjectarray as $value) { ?>
                                                    <option value="<?php echo $value->cid; ?>" <?php if ($val['cid'] == $value->cid) {
                                                        echo "selected";
                                                    } ?> ><?php $catName = $value->subject_name;
                                                        echo $catName; ?></option>
                                                <?php } ?></select> ,
                                            Level:
                                            <select name="did[]">
                                                ...
                                                <?php foreach ($difficult_level as $value) { ?>
                                                    <option value="<?php echo $value->did; ?>" <?php if ($val['did'] == $value->did) {
                                                        echo "selected";
                                                    } ?> ><?php echo $value->level_name; ?></option>
                                                <?php } ?></select> ,
                                            No. of Question added: <select name="no_of_questions[]" style="width:60px;">
                                                <option value="0">0</option>
                                                <option value="<?php echo $val['no_of_questions']; ?>"
                                                        selected><?php echo $val['no_of_questions']; ?></option>
                                            </select>
                                        </div>
                                        <?php
                                    }
                                    ?>
                                    <div class="form-group">
                                        Subject: <select name="cid[]" id='cid'>
                                ...
                                ?>
                                To add more questions, select subject, level & no. and click 'Add questions'. After
                                completion, click 'Submit quiz'.
                                <!--<?php
                                if ($redirect_track == '0') {
                                    echo "To add more questions, select subject, level & no. and click 'Add questions'. After completion, click 'Submit quiz'. ";
                                }
                                ?>-->
                                <a name="scrollHere"></a>
                                <div class="form-group">
                                    <input type="hidden" value="<?php echo $result->qselect; ?>" name="qselect"
                                           id="qselect">
                                    <input type="submit" value="Submit Quiz" name="submit_quiz" class="btn btn-default">

                                    <?php if ($result->qselect == "1") { ?>
                                        <input type="submit" value="Add questions" name="quiz_add"
...
if ($result->qselect == "0") {
    ?><br> <br>
    <a href="javascript:questionselection('<?php echo $result->quid; ?>','<?php echo $result->quiz_name; ?>','0','0');"
       class="btn btn-success">Add Questions Manually </a><br> <br>
    <?php
                            ...
                            <table class="table table-hover">
                                ...
                                foreach ($assigned_questions as $key => $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-th="Action"><a
                                                    href="<?php echo site_url('qbank/edit_question/' . $row->qid . '/' . $row->q_type); ?>"
                                                    class="btn btn-info btn-xs" target="edit_question">Edit</a>
                                            <a href="<?php echo site_url('quiz/remove_question_quiz/' . $result->quid . '/' . $row->qid); ?>"
                                               class="btn btn-danger btn-xs">Remove from Quiz</a>
                                            <?php if ($key != "0") { ?>
                                                <a href="javascript:cancelmove('Up','<?php echo $result->quid; ?>','<?php echo $row->qid; ?>','<?php echo $key + 1; ?>');"><img
                                                            src="<?php echo base_url(); ?>images/up.png" title="Up"></a>
                                            <?php } else { ?>
                                            ...
                                            if ($key == (count($assigned_questions) - 1)) {
                                                ...
                                                ?>
                                                <a href="javascript:cancelmove('Down','<?php echo $result->quid; ?>','<?php echo $row->qid; ?>','<?php echo $key + 1; ?>');"><img
                                                            src="<?php echo base_url(); ?>images/down.png" title="Down"></a>
                                                <?php
                                            }
                                            ?>
...
<div id="warning_div"
    ...
    <center><b>To which position you want to move this question? </b><br><input type="text" style="width:30px"
