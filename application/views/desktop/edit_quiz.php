                                ...
                                <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
										 ...
										 <div class="form-group">
											...
											<?php if($quiz['institute_id'] == $center['su_institute_id']){  echo "selected"; } ?>> <?php echo $center['organization_name']; ?></option>
											<?php } ?>
										 ...
										 <div class="form-group">
											...
											<?php if($quiz['cid'] == $subject['cid']){  echo "selected"; } ?>> <?php echo $subject['subject_name']; ?></option>
											<?php } ?>
											</select>
										 </div>
...
<div class="form-group">
 Subject: 
	...
	<option value="<?php echo $value->cid; ?>" <?php if($val['cid']==$value->cid ){ echo "selected"; } ?> ><?php $catName=$value->subject_name; echo $catName; ?></option>
	<?php } ?></select>  ,   
 Level: 
 <select name="did[]" >
