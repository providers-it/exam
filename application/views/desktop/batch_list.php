                        ...
                        if ($result == false) {
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td data-th="Action"><a
                                                href="javascript: if(confirm('Do you really want to remove this batch?')){ window.location='<?php echo site_url('batch/remove_batch/' . $row->gid); ?>'; }"
                                                class="btn btn-danger btn-xs">Remove</a>
                                        &nbsp;&nbsp;<a href="<?php echo site_url('batch/edit_batch/' . $row->gid); ?>"
