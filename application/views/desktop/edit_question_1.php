        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-6">
                        <form method="post"
                              action="<?php echo site_url('qbank/edit_question/' . $result['0']['qid']) . '/1'; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <table>
                                    ...
                                    foreach ($result['1'] as $okey => $option_value) {
                                        ?>
                                        <tr>
                                            <td valign="top"><?php echo $okey + 1; ?>) &nbsp;&nbsp; <input
                                                        type="checkbox" id="CheckBox[]" value="<?php echo $okey; ?>"
                                                        name="CheckBox[]" <?php if ($option_value['score'] > "0") {
                                                    echo "checked";
                                                } ?> ></td>
                                            <td valign="top">
                                        ...
                                        for ($j = 1; $j <= $this->input->post('add'); $j++) {
                                            ...
                                            <tr>
                                                <td valign="top"><?php echo $op . ")"; ?> &nbsp;&nbsp; <input
                                                            ...
                                                            value="<?php echo $op - 1; ?>" name="CheckBox[]"></td>
