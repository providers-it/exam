...
<option value="<?php echo $value->cid; ?>" <?php if($fcid==$value->cid){ echo 'selected';}?> ><?php echo $value->subject_name; ?></option>
<?php } ?></select>
...
<tr><th>Id</th><th>Question</th><th>Subject</th><th>Level</th><th>Question Type</th><th>Action</th></tr>
<?php
if($result==false){
?>
<tr>
...
<tr>
<td><?php echo $row->qid;?></td><td><?php echo substr(strip_tags($row->question),"0","50");?></td><td><?php echo $row->subject_name;?></td><td><?php echo $row->level_name;?></td><td><?php echo $type;?></td><td>
