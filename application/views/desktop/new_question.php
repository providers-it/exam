                        ...
                        <form method="post" action="<?php echo site_url('qbank/add_new'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td valign="top">1) &nbsp;&nbsp; <input type="radio" id="radiobtn" value="0"
                                                                                name="score" selected="selected"></td>
                                        <td valign="top">
                                            <textarea name="option[]"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td valign="top">2) &nbsp;&nbsp; <input type="radio" id="radiobtn" value="1"
                                                                                name="score"></td>
                                        <td valign="top">
                                            <textarea name="option[]"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td valign="top">3) &nbsp;&nbsp; <input type="radio" id="radiobtn" value="2"
                                                                                name="score"></td>
                                        <td valign="top">
                                            <textarea name="option[]"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td valign="top">4) &nbsp;&nbsp; <input type="radio" id="radiobtn" value="3"
                                                                                name="score"><?php $op = "5"; ?></td>
                                        <td valign="top">
                                            <textarea name="option[]"></textarea></td>
                                    </tr>
                                    <?php
