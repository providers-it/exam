                                ...
                                <div class="col-lg-6">
										...
										<form method="post" action="<?php echo site_url('qbank/edit_question/'.$result['0']['qid']);?>">
	                                       ...
	                                       <div class="form-group">
											...
											<option value="<?php echo $value->cid; ?>"  <?php if($result['0']['cid'] == $value->cid){ echo "selected"; }?> ><?php echo $value->subject_name; ?></option>
											<?php } ?></select>
										 </div>
...
<tr>
	<td></td>
	<td>Shuffle the options?   Please give <b>"No"</b> if the options contain "All the above" or "Both A & B"</td>
	</tr>
	<tr>
	<td></td>
	<td>
