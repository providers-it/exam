            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form method="post"
                              action="<?php echo site_url('qbank/edit_question/' . $result['0']['qid']); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="cid">
                                    <?php foreach ($subject as $value) { ?>
                                        <option value="<?php echo $value->cid; ?>" <?php if ($result['0']['cid'] == $value->cid) {
                                            echo "selected";
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="did">
                                    <?php foreach ($difficult_level as $value) { ?>
                                        <option value="<?php echo $value->did; ?>" <?php if ($result['0']['did'] == $value->did) {
                                            echo "selected";
                            ...
                            <div class="form-group">
                                <table>
                                    ...
                                    foreach ($result['1'] as $okey => $option_value) {
                                        ?>
                                        <tr>
                                            <td valign="top"><?php echo $okey + 1; ?>) &nbsp;&nbsp; <input type="radio"
                                                                                                           id="radiobtn"
                                                                                                           value="<?php echo $okey; ?>"
                                                                                                           name="score" <?php if ($option_value['score'] == "1") {
                                                    echo "checked";
                                                } ?> ></td>
                                            <td valign="top">
                                                <input type="hidden" value="<?php echo $option_value['oid']; ?>"
                                                       name="oids[]">
                                                <textarea
                                                        name="option[]"><?php echo $option_value['option_value']; ?></textarea>
                                            </td>
                                        </tr>
                                    ...
                                    if ($this->input->post('add')) {
                                        for ($j = 1; $j <= $this->input->post('add'); $j++) {
                                            ?>
                                            <tr>
                                                <td valign="top"><?php echo $op . ")"; ?> &nbsp;&nbsp; <input
                                                            type="radio" id="radiobtn" value="<?php echo $op - 1; ?>"
                                                            name="score"></td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>Shuffle the options? Please give <b>"No"</b> if the options contain "All the
                                            above" or "Both A & B"
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($result['0']['qshuffle'] == "1") { ?>
                                                <input type='radio' name='shuffle' value='1' checked="checked">Yes
                                                <input type='radio' name='shuffle' value='0'>No

                                            <?php } else { ?>
                                                <input type='radio' name='shuffle' value='1'>Yes
                                                <input type='radio' name='shuffle' value='0' checked="checked">No
                                            <?php } ?>
                                        </td>
                                    </tr>
