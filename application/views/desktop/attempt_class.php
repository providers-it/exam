...
<div id="content" class="testd">
    ...
    <div class="class_text_board">
        <div class="class_heading">
            Notes <img title="Attach file" style="margin-left:20px;cursor:pointer;"
                       src="<?php echo base_url(); ?>images/attachment.png" onClick="show_drop();">
            <div id="page_res"></div>
        </div>
        <div id="page" contenteditable="true"
             onKeyup="javascript: if (event.keyCode=='13') postclass_content('<?php echo $class_id; ?>');">
    ...
    <div class="class_comment_board">
        Comments<br>
        <div id="comnt_optn"
             style="border:2px groove #eee;background:#F9FFF9;border-radius:10px;display:none;width:200px;position:absolute;margin-top:50px;margin-left:20px;padding:10px;">
            <img OnClick="hide_options()" title="Minimize" style="width:12px;height:12px;float:right;cursor:pointer;"
                 src="<?php echo base_url(); ?>images/cross.png"><br><br>
        ...
        <br>
        <input type="text" id="comment_send" name="class_cont" placeholder="Enter your comment"
               onKeyup="javascript: if (event.keyCode=='13') comment('<?php echo $class_id; ?>');">
    </div>

    <div style="clear:both;"></div>
    Tips: Enter key will send data to your users.
    <br><br>
    <a href="<?php echo site_url('liveclass/close_class/' . $class_id); ?>" class="btn btn-danger btn-xs">Close This
        Class</a>
