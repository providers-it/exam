        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="panel-group" id="accordion">
                    ...
                    if ($logged_in['su'] == "1") {
                        ?>
                        Live Classroom is a place where you can post live content  (text, image or any other attachments) to users of selected batches.
                        <br>
                    ...
                    if ($logged_in['su'] == "1") {
                        ?>
                        <a href="<?php echo site_url('liveclass/add_new'); ?>" class="btn btn-success">Initiate new
                            class</a>
                        <?php
                    }
                    ?>
                    <a href="<?php echo site_url('liveclass/closed_classes/'); ?>" class="btn btn-warning">Closed
                        classes</a>
                    <br><br>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($logged_in['su'] == "1") {
                                            ?>
                                            <a href="<?php echo site_url('liveclass/attempt/' . $row['class_id']); ?>"
                                               class="btn btn-success btn-xs">Post Content</a>
                                            &nbsp;&nbsp;
                                            <a href="<?php echo site_url('liveclass/close_class/' . $row['class_id']); ?>"
                                               class="btn btn-danger btn-xs">Close Class</a>
                                            &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <a href="<?php echo site_url('liveclass/attempt/' . $row['class_id']); ?>"
                                               class="btn btn-warning btn-xs">Attend</a>
                                            &nbsp;&nbsp;
