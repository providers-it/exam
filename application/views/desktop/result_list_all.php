...
if($row->publish == 0)
{ ?>
	<a href="javascript: if(confirm('Do you really want to publish this result?')){ window.location='<?php echo site_url('result/publish_result/'.$row->rid);?>'; }" class="btn btn-success btn-xs">Publish</a>
<?php
}
?>
