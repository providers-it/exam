    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default">
                ...
                <img style="padding:20px;" src="<?php echo base_url(); ?>logo/logo.png" title="Logo">
                ...
                <div class="panel-body">
                    ...
                    if ($this->session->flashdata('result')) {
                        ...
                        echo "<div class='alert alert-danger' >" . $result_r . "</div>";
                    }
                    ?>
                    ...
                    <fieldset>
                        <div class="form-group">
                            <input class="form-control" name="user_email" placeholder=" Registered Email ID" type="text"
                        ...
                        <div class="checkbox">
                            <label>
                                ...
                                <a href="<?php echo site_url('login/'); ?>">Remember your password? Login</a> &nbsp;&nbsp;&nbsp;&nbsp;
