...
if($resultstatus){ echo "<div class='alert alert-success'>".$resultstatus."</div>"; }
 ?> 
<form method="post" action="<?php echo site_url('centers/update_center/'.$gid);?>">
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label>Center Name</label>
		                                         <input type='text'  class="form-control"  name='centername'  value="<?php echo $center['organization_name']; ?>">
