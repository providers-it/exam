        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-6">
                        <form method="post"
                              action="<?php echo site_url('qbank/edit_question/' . $result['0']['qid'] . '/5'); ?>">
                            ...
                            <div class="form-group">
                                <table>
                                    ...
                                    foreach ($result['1'] as $okey => $option_value) {
                                        ?>
                                        <tr>
                                            <td valign="top" style="height:30px;"><?php echo $okey + 1; ?>)
                                                &nbsp;&nbsp;
                                            </td>
                                            <td valign="top">
                                                ...
                                                <input type="text" name="option[]"
                                                       value="<?php echo $option_value['option_value']; ?>">Ex:
                                                option<?php echo $okey + 1; ?>=Answer<?php echo $okey + 1; ?>  </td>
                                        </tr>
                                    ...
                                    if ($this->input->post('add')) {
                                        for ($j = 1; $j <= $this->input->post('add'); $j++) {
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top"><input type="text" name="option[]">Ex:
                                                    option<?php echo $op; ?>=Answer<?php echo $op; ?> </td>
                                            </tr>
                                            <?php
                                            $op++;
                                        }
