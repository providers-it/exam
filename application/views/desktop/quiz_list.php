                        ...
                        <table class="table table-hover">
                            ...
                            if ($result == false) {
                                ...
                                foreach ($result as $row) {
                                    ?>
                                    <tr>
                                        <td data-th="Id"><?php echo $row->quid; ?></td>
                                        ...
                                        <td data-th="Action">
                                            <a href="<?php echo site_url('quiz/attempt/' . $row->quid); ?>"
                                               class="btn btn-warning btn-xs">Attempt</a>
                                            &nbsp;&nbsp;
                                            <?php
                                            if ($logged_in['su'] == "1") {
                                                ?>
                                                <a href="javascript: if(confirm('Do you really want to remove this quiz?')){ window.location='<?php echo site_url('quiz/remove_quiz/' . $row->quid); ?>'; }"
                                                   class="btn btn-danger btn-xs">Remove</a> <a
                                                        href="<?php echo site_url('quiz/edit_quiz/' . $row->quid); ?>"
