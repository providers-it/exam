                        ...
                        <div class="panel-body">
                            ...
                            <form method="post" action="<?php echo site_url('qbank/remove_qids/'.$limit);?>" id="removeqids">
                                <table class="table table-hover">
                                    <thead>
                                        <tr><th>Id</th><th>Exam name</th><th>Subject</th><th>Start time</th><th>End time</th><th>Duration</th><th>Action</th></tr>
...
<td  data-th="Subject"><?php echo $row->subject_name;?></td> <!-- EDITING THIS --> 
