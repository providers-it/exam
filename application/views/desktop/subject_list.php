                        ...
                        if ($result == false) {
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td data-th="Action"><a
                                                href="javascript: if(confirm('Do you really want to remove this subject?')){ window.location='<?php echo site_url('subject_main/remove_subject/' . $row->cid); ?>'; }"
                                                class="btn btn-danger btn-xs">Remove</a>
                                        <a href="<?php echo site_url('subject_main/edit_subject/' . $row->cid); ?>"
