...
return;
 ...
 //$data['institute'] = $this->user->institute_list($limit);
...
function selected_subject($selectedValue='')
{
   
	if($selectedValue)
    {
        //console.log(12);
        $data['selected_question_subject'] = $this->subject->get_selectedInsitute_subject($selectedValue);
  		
		$array = json_decode(json_encode($data['selected_question_subject']),true);
